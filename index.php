...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="icon" href="img/cropped-np-favicon-1-32x32.png" sizes="32x32"/>
        <link rel="icon" href="img/cropped-np-favicon-1-192x192.png" sizes="192x192"/>
        <link rel="apple-touch-icon-precomposed" href="img/cropped-np-favicon-1-180x180.png"/>
        <meta name="msapplication-TileImage" content="img/cropped-np-favicon-1-270x270.png"/>
    ...
    <body class="front-page body-home">
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W89TX54" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
        <!-- End Google Tag Manager (noscript) -->


        <!-- start content -->
        <main role="main" class="updates-2019">
            <section class="section section-landing-banner section-banner-full-xxx">
                ...
                <figcaption class="">
                    ...
                    <div class="location-choice">
                        <a href="/kenya" class="button button-default button-ghost" title="">Kenya</a>

                        <a href="/sa" class="button button-default button-ghost" title="">South Africa</a>

                        <a href="/careers" class="button button-default button-ghost" title="">Careers</a>
                    </div>
                </figcaption>
            </section>
