            ...
            <section class="section section-campaign-main" style="background-image: url('img/bg.png');">
                <article class="article">
                    ...
                    <div class="campaign-school">
                        <!--<img src="<?php echo get_field('school_image', $post->ID); ?>" alt="" class="campaign-school-image campaign-school-map">-->

                        <?php 
                            $location = get_field('school-map');
                            if( !empty($location) ):
                        ?>
                        <div class="acf-map campaign-school-map" style="display:nonne;">
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB5cq_srSJYwHts_qDBM0MskEuyDMPGWFY"></script>
<script type="text/javascript">
    (function($) {
