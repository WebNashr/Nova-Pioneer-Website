...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDxe4GTTXVwu9i-xiW52kKkLJSdBbRV9ro"></script>
<script type="text/javascript">
    (function($) {
                ...
                <article class="article">
                    ...
                    <div class="campaign-school">
                        ...
                        <?php 
                            ...
                            if( !empty($location) ):
                        ?>
                        <div class="acf-map campaign-school-map" style="display:none;">
