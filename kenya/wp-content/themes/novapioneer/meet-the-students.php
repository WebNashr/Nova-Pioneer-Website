...
<?php if (have_posts()): ?>
    ...
    <?php while (have_posts()): the_post(); ?>
            ...
            <section class="section section-hero corporate-hero" <?php if (has_post_thumbnail()): echo 'style="background-image: url(' . wp_get_attachment_image_src(get_post_thumbnail_id(), 'single-post-thumbnail')[0] . ');"'; endif; ?> data-enllax-ratio="0.1">
                    ...
                    <div class="section-content">
                        <?php foreach (get_field('student_blogs') as $blog_post): $blog_post = (object)$blog_post; ?>
                            ...
                            <div class="section-content-item section-content-item-third blog-article">
                                <a href="<?php echo $blog_post->url; ?>" target="_blank"><div class="blog-article-image" style="background-image: url(<?php echo $blog_post->picture; ?>);"
                                        title="<?php echo $blog_post->title; ?>"></div></a>
