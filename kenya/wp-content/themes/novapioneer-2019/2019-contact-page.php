...
<div class="updates-2019">
    ...
    <section class="section section-banner" style="margin-bottom: 0rem;">
        <figure class="">
            <img src="<?php echo wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), '16-9-hero')[0]; ?>"
                 alt="">
            ...
            <figcaption class="flex-row">
                ...
                <div class="banner-social">
                    ...
                    <a href="<?php if (function_exists('dc_dcb_dev_content_block')) echo do_shortcode('[dcb name=social-link-facebook]'); ?>"
                       title="" target="_blank">
                        <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>
                                facebook</title>
                            <path d="M12 13h-1a1 1 0 0 1 0-2h1V8a1 1 0 0 1 1-1h3a1 1 0 0 1 0 2h-2v2h2a1 1 0 0 1 0 2h-2v7a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1h-3a1 1 0 0 1 0-2h2V5H5v14h7v-6z"
    ...
    <section class="section section-schools">
        <div class="section-school-list">
            ...
            <?php foreach ($schools as $school): $school = (object)$school; ?>
                    ...
                    <div class="school-summary">
                            ...
                            <span class="icon-heading">
                                <span class="icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24"
                                         xmlns="http://www.w3.org/2000/svg"><title>map</title><path
                                                d="M14.535 19.885L9 17.118l-5.553 2.776A1 1 0 0 1 2 19V8a1 1 0 0 1 .553-.894l5.982-2.991a.996.996 0 0 1 .93 0L15 6.882l5.553-2.776A1 1 0 0 1 22 5v11a1 1 0 0 1-.553.894l-5.982 2.991a.996.996 0 0 1-.93 0zM14 17.382V11a1 1 0 0 1 2 0v6.382l4-2V6.618l-4.553 2.276a1 1 0 0 1-.894 0L10 6.618V13a1 1 0 0 1-2 0V6.618l-4 2v8.764l4.553-2.276a1 1 0 0 1 .894 0L14 17.382z"
                        ...
                        <p class="school-contact">
                            <span class="icon-heading">
                                <span class="icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24"
                                         xmlns="http://www.w3.org/2000/svg"><title>phone-1</title><path
                                                d="M15.938 14.743l-1.379 1.378a.998.998 0 1 1-1.412-1.412l1.757-1.756a.998.998 0 0 1 .902-.273l4.391.878a.998.998 0 0 1 .803.98v5.267a.998.998 0 0 1-.767.971c-3.387.806-8.222-.523-12.355-4.655-4.134-4.131-5.46-8.966-4.654-12.354A.998.998 0 0 1 4.196 3h5.27c.475 0 .885.336.979.803l.878 4.39a.998.998 0 0 1-.273.901l-1.233 1.232a10.469 10.469 0 0 0 2.195 2.68.998.998 0 1 1-1.31 1.507 12.16 12.16 0 0 1-.63-.588 12.654 12.654 0 0 1-2.379-3.337.998.998 0 0 1 .188-1.15L9.26 8.06l-.613-3.063H5.036c-.292 2.69.942 6.403 4.253 9.712 3.312 3.31 7.025 4.546 9.714 4.255v-3.608l-3.065-.613z"
                                                fill="#000" fill-rule="nonzero"/></svg>
                                </span>
                        ...
                        <p class="school-contact">
                            <span class="icon-heading">
                                <span class="icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24"
                                         xmlns="http://www.w3.org/2000/svg"><title>mail</title><path
                ...
                if (get_field('latitude', $school->ID) && get_field('longitude', $school->ID)) :
