...
<div class="updates-2019">
    ...
    <section class="section section-admissions section-admissions-large">
        <div class="card-container">
            <figure class="card card-admissions card-admissions-large">
            ...
            <?php if( have_rows('steps') ): ?>
                ...
                <figure class="card card-admissions card-admissions-large">
                    ...
                    <figcaption>
                        ...
                        <div class="admissions-description"><?php the_sub_field('description'); ?></div>
                    </figcaption>
                </figure>
                <?php endwhile; ?>
            <?php endif; ?>
    ...
    <section class="section section-signpost">
        ...
        <h2><?php the_field('admissions_start_title'); ?></h2>
        <?php else : ?>
