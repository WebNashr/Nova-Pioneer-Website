...
<body  <?php body_class('body-careers'); ?>>
...
<header class="page-header <?php if (is_admin_bar_showing()): echo 'style="top:32px;"'; endif; ?>" id="header-container">
    ...
    <section class="header-section header-section-main">
        ...
        <a href="<?php echo site_url('/working-at-nova-pioneer/apply/'); ?>" class="button button-small button-primary header-apply">Join us</a>
