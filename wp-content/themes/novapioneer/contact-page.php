                ...
                <div class="section-pair">
                    <div class="section-navigation">
                        ...
                        <div class="social-media-links">
                            ...
                            <a href=" <?php the_field('linkedin')?>" target="_blank"><span class="social-icon linkedin-icon"></span>LinkedIn</a><br/>
                        </div>
                    </div>
                ...
                <div class="section-pair">
                    <div class="section-navigation">
                        ...
                        <div class="social-media-links">
                            ...
                            <a href=" <?php the_field('linkedin_ke')?>"target="_blank" ><span class="social-icon linkedin-icon"target="_blank"></span>LinkedIn</a><br/>
                        </div>
                    </div>
                    <div class="section-content">
                        <?php
