...
class NPRadioButtons extends SettingsField
{
    private $options;
    ...
    private function render_options()
    {
        ...
        foreach( $this->options as $option ):
            ...
            if( is_array($this->default_options) && isset($this->default_options[$option]) ):
                ...
                echo '<input id="'.$this->name.'" type="radio" value="'.strtolower($option).'" checked />';
                ...
                echo '<input id="'.$this->name.'" type="radio" value="'.strtolower($option).'" />';
                echo '<label for="'.$this->name.'" >';
                echo ucwords($option);
                echo '</label>';
