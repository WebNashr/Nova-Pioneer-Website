<?php require_once('happyfox-chat-config.php') ?>
<div class='hfc-settings'>
    <div class='header'>
        <img class='logo' src="<?php echo WP_PLUGIN_URL . HFC_ASSET_LOGO_URL ?>" alt="HappyFox Chat" />
        ...
        <div class='content'>
            ...
            <p>Sign in to your HappyFox Chat account, copy your API key from the <a href="<?php echo HFC_APP_MANAGE_PAGE ?>" target="_blank">WordPress App</a> page and paste it here</p>
        </div>
    </div>
    <hr class='line-break'/>
    ...
    <div class='footer-text'>
        ...
        <p>Click <a href="<?php echo HFC_APP_MANAGE_PAGE ?>" target="_blank">here</a> to get your API key. New user? <a href="<?php echo HFC_APP_SIGNUP_PAGE ?>" target="_blank">Sign up</a> here for a free HappyFox Chat account.</p>
        <p>Questions? Come <a href="<?php echo HFC_APP_REF_PAGE ?>" target="_blank">chat with us</a> or <a href="mailto:support@happyfoxchat.com">send us an email</a>.
    </div>
    <hr class='line-break'/>
</div>
