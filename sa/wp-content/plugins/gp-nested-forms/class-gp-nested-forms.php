...
class GP_Nested_Forms extends GP_Plugin {
	...
	public function init() {
		...
		add_action( 'wp_enqueue_scripts', array( $this, 'fix_jquery_ui_issue' ), 1000 );
                ...
                // Make single entry label and plural entry lable translatable
                add_filter('gform_multilingual_field_keys', array($this, 'gf_translate_entry_labels'));
	}
...
//			),
	...
	public function documentation() {
        ...
        public function gf_translate_entry_labels($field_keys) {
