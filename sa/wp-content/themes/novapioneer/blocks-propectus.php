...
<?php if (have_posts()): ?>
    ...
    <?php while (have_posts()): the_post(); ?>
        ...
        <section class="section section-hero about-np" <?php if (has_post_thumbnail()): echo 'style="background-image: url(' . wp_get_attachment_image_src(get_post_thumbnail_id(), 'single-post-thumbnail')[0] . ');"'; endif; ?> data-enllax-ratio="0.1">
