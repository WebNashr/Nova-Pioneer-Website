                        ...
                        <?php if( !empty($flip_photo) ): ?>
                          <div class="image-wrap">
                            <div class="image-flip">
                                <img src="<?php echo wp_get_attachment_image_src( get_post_thumbnail_id( $leader->ID ), 'profile-square' )[0]; ?>" alt="<?php echo $leader->post_title; ?>">
                ...
                <?php foreach( get_field('management') as $manager  ): $manager = (object)$manager; ?>
                    <div class="section-content-item section-content-item-quarter profile">
                        ...
                        <?php if( !empty($flip_photo) ): ?>
                          <div class="image-wrap">
                            <div class="image-flip">
                                <img src="<?php echo wp_get_attachment_image_src( get_post_thumbnail_id( $manager->ID ), 'profile-square' )[0]; ?>" alt="<?php echo $manager->post_title; ?>">
                        ...
                        <li>
                            <div class="profile">
                                ...
                                <?php if( !empty($flip_photo) ): ?>
                                  <div class="image-wrap">
                                    <div class="image-flip">
                                        <img src="<?php echo wp_get_attachment_image_src( get_post_thumbnail_id( $member->ID ), 'profile-square' )[0]; ?>" alt="<?php echo $member->post_title; ?>">
