...
// parallax effect
    ...
    $(document).ready(function () {
        ...
        //     $('.no-mobile-parallax').removeClass('parallax');
        //     console.log('parallax class removed')
        // }
        ...
        //
        // if (deviceWidth < 1200) {
        //     $("#no-mobile-parallax").data('enllax-ratio', 0);
        //     $("#no-mobile-parallax").removeClass('parallax');
        //     //$("#no-mobile-parallax").removeAttr("enllax-ratio");
        //    // $("#no-mobile-parallax").removeAttr('enllax-type');
        //     $("#").data('enllax-ratio')
        //
        // }
